...
| `cpu-averages-hide-saturation` | A host-wide CPU utilization of 20% does not mean the workload has 80% CPU headroom. A single CPU pinned at 100% — handling all softirq processing for a single-stream network flow, or serving as the sole IRQ target for... | 530 | concept |
